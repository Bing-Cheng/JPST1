function cbJPSTH_show(Version, matrix, xHist, yHist, xcorrHist, scoopHist, saveF,toprg,s)
...
if s==1%cb scale for display better;
    c_Scale = 20;
else
    c_Scale= 2;
end
thisto1 = thisto(501:end-500)*c_Scale;%cb scale o.w. show a line;
