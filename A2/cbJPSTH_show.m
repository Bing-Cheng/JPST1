function cbJPSTH_show(Version, matrix, xHist, yHist, xcorrHist, scoopHist, saveF)
...
vec2 = reshape(matrix, size(matrix,1)^2,1);
 ...
 % toprg =max(vec2);
 toprg = 17.6326;
 disRange = [mean1+1.5*variance1-3,toprg];
...
thisto1(1:500) = (thisto1_min*3 + thisto1_max)/4;
